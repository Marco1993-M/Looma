...
export default function Navbar() {
  ...
  const scrollToPlans = (duration = 800) => {
  ...
  return (
    <nav className="top-0 left-0 w-full z-50 bg-transparent px-4 sm:px-8 py-4">
      <div className="relative h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          <button
            type="button"
            className="border border-gray-300 text-black px-4 py-2 rounded-lg hover:bg-white hover:text-black transition"
          >
            Login
          </button>
          ...
          <button
            type="button"
            className="border border-gray-300 text-black px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-white hover:text-black transition"
          >
            <FaPhoneAlt />
            Book a Call
          </button>

...
import { PauseCircle, Clock } from "lucide-react"; // Example icons
    ...
    <section id="plans" className="pt-2">
      <div className="max-w-6xl mb-32 mx-auto text-center">
        ...
        <div className="grid md:grid-cols-5 gap-8 items-stretch">
          ...
          <div className="col-span-1 flex items-center justify-center rounded-2xl overflow-hidden">
            <img
              src="/price.png"
